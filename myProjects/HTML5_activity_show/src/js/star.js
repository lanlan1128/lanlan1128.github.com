...
starObj.prototype.init = function() {
	...
	for(var i = 0; i < this.num; i++) {
		this.stars[i] = $('<div class="ele star p1_star' + i + '"></div>');
		this.stars[i].css({
			left: this.x[i] * deviceWidth / 640 + 'px',
			top: (this.y[i] - 128) * deviceWidth / 640 + 'px'
		});
		$('#page1').append(this.stars[i]);
	}
